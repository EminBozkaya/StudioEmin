...
namespace PhotoEmin
{
    public partial class Form1 : Form
    {
        ...
        private void PrintDocument1_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            //currentYlast += 200; // Önceki metinden sonra bir boşluk bırakmak için
            e.Graphics.DrawString(emptyTitleText, emptyTitleFont, Brushes.Black, new RectangleF(20, (int)currentYlast + 110, 235, 18), new StringFormat { Alignment = StringAlignment.Near, LineAlignment = StringAlignment.Near });
        }
